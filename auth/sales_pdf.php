            ...
            <div class="container-sm mb-5 mt-3">
                ...
                <div class="container">
                                ...
                                while ($row = mysqli_fetch_assoc($transitions)) {
                                    echo "
                                        <tr>
                                            ...
                                            <td>  " . $row['username'] . " </td>
                                            <td> " . $row['trans_amount'] . " Rp </td> <!-- Ganti dengan Rp -->
                                            <td> " . $row['card_type'] . " </td>
                                        </tr>
                                        ";
                                }
                    ...
                    <div class="row">
                        ...
                        <div class="col-xl-3">
                            <ul class="list-unstyled">
                                <li class="text-muted ms-3"><span class="text-black me-4">SubTotal</span><?php echo $total ?> Rp</li> <!-- Ganti dengan Rp -->
                                <li class="text-muted ms-3 mt-2"><span class="text-black me-4">Tax(0%)</span>0 Rp</li> <!-- Ganti dengan Rp -->
                            </ul>
                            <p class="text-black float-start"><span class="text-black me-3"> Total Amount</span><span style="font-size: 25px;"><?php echo $total ?></span> Rp</p> <!-- Ganti dengan Rp -->
                        </div>
                    </div>
                    <hr>
                    <div class="row">
