            ...
            <div class="container-sm mb-5 mt-3">
                ...
                <div class="container">
                    ...
                    <div class="row">
                        ...
                        <div class="col-xl-3">
                            <ul class="list-unstyled">
                                <li class="text-muted ms-3"><span class="text-black me-4">SubTotal</span><?php echo $trans_amount ?> IDR</li>
                                <li class="text-muted ms-3 mt-2"><span class="text-black me-4">Tax(0%)</span>0 Rp</li>
                            </ul>
                            <p class="text-black float-start"><span class="text-black me-3"> Total Amount</span><span style="font-size: 25px;"><?php echo $trans_amount ?></span> IDR</p>
                        </div>
                    </div>
                    <hr>
                    <div class="row">
