...
if (isset($_POST['newUser']) && isset($_POST['username']) && isset($_POST['email']) && isset($_POST['pass'])) {
    ...
    if ($auth->createUser($username, $email, $pass) == '200') {
        $mailHtml = "<div>
        <h3>Welcome $username to triptrip. Travel Indonesia like never before. <br>
        <a href='http://localhost/triptrip/listing.php'>Check our JDAR recommended packages</a> and start planning for your next trip!
        </div>";
